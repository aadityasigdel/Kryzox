...
const FeatureCard1 = ({
  ...
  return (
    ...
    >
      <div className="h-[60px] w-[60px] rounded-md bg-[#791479] text-white grid place-content-center transition ease-in-out duration-500 group-hover:rotate-15 group-hover:scale-110">
        <Icon />
      </div>
