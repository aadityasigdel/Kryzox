...
export default function RewardWinners() {
  ...
  // Track winner inputs for each user
        ...
        {selectedUsers.length === 0 ? (
          ...
          <ul className="space-y-3">
            {selectedUsers.map((id) => (
              ...
              >
                <span className="text-teal-300 font-semibold">User ID:</span>{" "}
                {id}
              </li>
            ))}
          </ul>
        ...
        {selectedUsers.map((id) => (
          ...
          >
            ...
            <input
              ...
              onChange={(e) => handleChange(id, "position", e.target.value)}
