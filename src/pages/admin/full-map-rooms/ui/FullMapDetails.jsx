...
import { useNumberofApproved } from "./NumberofApproved";
...
const TournamentCard = ({ tournament }) => {
    const { count, loading } = useNumberofApproved(); // ✅ now inside the component
        ...
        <div className="flex-1 bg-gray-900/80 rounded-xl shadow-md p-5 flex flex-col justify-between gap-4 max-h-full">
            ...
            <div className="text-sm flex flex-col gap-1 text-gray-300">
                ...
                <p>
                    ...
                    {loading ? "..." : `${count}/${tournament.maxplayer}`}
                </p>
            </div>

            {count >= tournament.maxplayer / 2 &&
                tournament.status === "PENDING" && (
