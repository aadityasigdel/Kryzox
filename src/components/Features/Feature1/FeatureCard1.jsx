...
//       <div
//         className="absolute h-[5px] w-[5px] right-[10%] top-[10%] z-10 rounded-full transition-colors group-hover:bg-[#79a5d5] animate-ping delay-[500ms]"
//         style={{ animationDelay: "500ms" }}
//       ></div>
//       <div
//         className="absolute h-[5px] w-[5px] left-[5%] bottom-[20%] z-10 rounded-full transition-colors group-hover:bg-[#c84de5] animate-ping  delay-[500ms]"
//         style={{ animationDelay: "500ms" }}
//       ></div>
