const FeatureCard2 = ({ image, title, description, bg, content1, price }) => {
  ...
  return (
    <div className="group relative min-h-[410px] w-full md:max-w-[300px] bg-[#28194A] rounded-3xl border-[.1px] border-[#552555] text-left flex flex-col gap-5 pb-5  duration-500 ease-in-out hover:scale-105 md:hover:scale-110">
      ...
      >
        ...
        <button className="absolute left-5 px-4 py-1.5 bg-black text-[#6e95c2] rounded-3xl top-5">
          {content1 || "test message"}
        </button>
        <button
          className="absolute right-5 px-4 py-1.5  backdrop-blur-lg   text-white rounded-3xl top-5 animate-custom-pulse"
          style={{
